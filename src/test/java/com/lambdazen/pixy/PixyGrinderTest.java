...
public class PixyGrinderTest extends TestCase {
    public String[][] KENNEDY_FAMILY_TREE = new String[][] {
        new String[] {
            "Joseph Patrick Kennedy, Sr.", "male", "1888", "1969", "Joe", null, null, "Rose Elizabeth Fitzgerald"
        },
        new String[] {"Rose Elizabeth Fitzgerald", "female", "1890", "1995", null, null, null, null},
        new String[] {
        ...
        new String[] {"John Vernou Bouvier III", "male", "1891", "1957", "Black Jack", null, null, "Janet Lee Bouvier"},
        new String[] {"Janet Lee Bouvier", "female", "1907", "1989", null, null, null, null},
        new String[] {
            "Jacqueline Lee Bouvier",
            "female",
            "1929",
        ...
        new String[] {"Edward William Spencer Cavendish", "male", "1895", "1950", null, null, null, "Mary Cavendish"},
        new String[] {"Mary Cavendish", "female", "1895", "1988", null, null, null, null},
        new String[] {
            "Eunice Mary Kennedy",
            "female",
            "1921",
        ...
        new String[] {"Robert Sargent Shriver, Sr.", "male", "1878", "1942", null, null, null, "Hilda Shriver"},
        new String[] {"Hilda Shriver", "female", "1883", "1977", null, null, null, null},
        new String[] {
        ...
        new String[] {"Sydney Turing Barlow Lawford", "male", "1865", "1953", null, null, null, "May Sommerville Bunny"
        },
        new String[] {"May Sommerville Bunny", "female", "1883", "1972", null, null, null, null},
        new String[] {
        ...
        new String[] {"Ethel Skakel Kennedy", "female", "1928", null, null, "George Skakel", "Ann Brannack", null},
        new String[] {"George Skakel", "male", "1892", "1955", null, null, null, "Ann Brannack"},
        new String[] {"Ann Brannack", "female", "1892", "1955", null, null, null, null},
        new String[] {
            "Jean Ann Kennedy",
            "female",
            "1928",
        ...
        new String[] {"Stephen Edward Smith Sr.", "male", "1927", "1990", null, null, null, "Jean Ann Kennedy"},
        new String[] {
        ...
        new String[] {
            ...
            null,
            "Joan",
            "Henry Wiggin Bennett, Jr.",
            "Virginia Joan Bennet",
            null
        },
        new String[] {"Henry Wiggin Bennett, Jr.", "male", "1895", "1981", null, null, null, "Virginia Joan Bennet"},
        new String[] {"Virginia Joan Bennet", "female", "1900", "1975", null, null, null, null},
        new String[] {
        ...
        new String[] {"Edwin Arthur Schlossberg", "male", "1945", null, null, null, null, "Caroline Bouvier Kennedy"},
        new String[] {
        ...
        new String[] {"Carolyn Jeanne Bessette", "female", "1966", "1999", null, null, null, null},
        new String[] {
        ...
        new String[] {"Malissa Feruzzi", "female", "1963", null, "Mary Elizabeth", null, null, null},
        new String[] {
        ...
        new String[] {"Arnold Schwarzenegger", "male", "1947", null, null, null, null, "Maria Owings Shriver"},
        new String[] {
        ...
        new String[] {"Linda Sophia Potter", "female", "1956", null, null, null, null, null},
        new String[] {
        ...
        new String[] {"Jeanne Eileen Ripp", "female", "1965", null, "Jeannie", null, null, null},
        new String[] {
        ...
        new String[] {"Alina Mojica", "female", "1965", null, null, null, null, null},
        new String[] {
        ...
        new String[] {"James Peter McKelvy, Sr", "male", "1955", null, null, null, null, "Sydney Maleia Kennedy Lawford"
        },
        new String[] {
        ...
        new String[] {"Robert Beebe Pender, Jr.", "male", "1953", null, null, null, null, "Victoria Francis Lawford"},
        new String[] {
        ...
        new String[] {"Anne Henry", "female", "1975", null, null, null, null, null},
        new String[] {
            "Kara Anne Kennedy",
            "female",
            "1960",
        ...
        new String[] {"Katherine Anne Gershman", "female", "1959", null, "Kiki", null, null, null},
        new String[] {
        ...
        new String[] {"Amy Savell", "female", "1979", null, null, null, null, null}
    };
    ...
    public void loadGraph() {
        for (String[] kennedy : KENNEDY_FAMILY_TREE) {
            Vertex v = graph.addVertex("name", kennedy[0], "sex", kennedy[1], "born", new Integer(kennedy[2]));
        ...
        if (name != null) {
            try {
                ...
                if (label.equals("father")) {
                    ...
                    assertEquals(
                            "for " + name + " with " + other.property("sex").getClass(),
                            "female",
                            other.property("sex").value());
                }
    ...
    public void testRelationships(boolean shortRules) {
        ...
        PixyTheory pt = new PixyTheory("father(Child, Father) :- out(Child, 'father', Father). "
        ...
        // Father
        GraphTraversal pipeline = gtFromIter(graph.verticesByIndex("name", "John Fitzgerald Kennedy, Sr."))
                .as("c");
        ...
        if (shortRules) {
            pt = pt.remove("spouse/2", "parent/2")
                    .extend("spouse(Spouse1, Spouse2) :- both(Spouse1, 'wife', Spouse2)."
        ...
        pipeline = pp.pixyStep(pipeline);
        pipeline = GraphTraversalExt.coalesce(pipeline, "p")
                .properties("name")
                .value()
                .order();
        System.out.println("Pixy pipe: " + pp);
        ...
        pt = pt.extend("brother(Person1, Person2) :- sibling(Person1, Person2), property(Person2, 'sex', 'male')."
        ...
        pipeline = gtFromIter(graph.verticesByIndex("name", "John Fitzgerald Kennedy, Sr."));
        pp = pt.extend(
                        "youngerBrother(X, Y) :- brother(X, Y), property(X, 'born', BX), property(Y, 'born', BY), BY > BX. ")
        ...
        pp = pt.extend(
                        "olderSister(X, Y) :- sister(X, Y), property(X, 'born', BX), property(X, 'born', BX), property(Y, 'born', BY), BY < BX. ")
        ...
        pt = pt.extend("brotherInLaw(Person, BIL) :- spouse(Person, Spouse), brother(Spouse, BIL). "
        ...
        pp = pt.extend(
                        "deadNephew(Person, Nephew) :- nephew(Person, Nephew), property(Nephew, 'died', _), property(Person, 'died', _).")
                .makePipe("deadNephew($, &)");
        pipeline = pp.pixyStep(pipeline).properties("name").value().order();
        System.out.println("Pixy pipe: " + pp);
        System.out.println("Pipeline: " + pipeline);
        ...
        pipeline = gtFromIter(graph.verticesByIndex("name", "John Fitzgerald Kennedy, Sr."));
        pp = pt.extend("funcle(X, Y) :- uncle(Z, Y), !, parent(X, T), brother(T, Y). ")
                .makePipe("funcle(&, $)");
        pipeline = pp.pixyStep(pipeline).properties("name").value().order();
        System.out.println("Pixy pipe: " + pp);
        System.out.println("Pipeline: " + pipeline);
        ...
        pipeline = gtFromIter(graph.verticesByIndex("name", "Edward Moore Kennedy, Sr."));
        pp = pt.extend("livingNephew(Person, Nephew) :- nephew(Person, Nephew), living(Nephew).")
                .makePipe("livingNephew($, &)");
        pipeline = pp.pixyStep(pipeline).properties("name").value().order();
        System.out.println("Pixy pipe: " + pp);
        System.out.println("Pipeline: " + pipeline);
        ...
        try {
            pp = pt.extend("one(Y, X) :- two(X, Y). two(X, Y) :- two(Y). two(Y) :- one(X, Y). ")
                    .makePipe("two($, &)");
        ...
        PixyTheory ptTemp =
                pt.extend("ancestor_2(Person, Ancestor) :- outLoop(Person, ['father', 'mother'], Ancestor, [2, 2])."
        ...
        ptTemp = pt.extend("ancestor_1_2(Person, Ancestor) :- outLoop(Person, ['father', 'mother'], Ancestor, [1, 2])."
    ...
    public void testPipes() {
        ...
        PixyTheory pt = new PixyTheory("testIn(Vin, Vout) :- in(Vin, Vout), !, 'foo' = 'bar'." + "testIn(Vin, Vout)."
        ...
        GraphTraversal pipeline = graph.traversal().E().as("e").inV().as("xvin");
        ...
        // Go over all edges and make sure that the relationships hold
        pt = new PixyTheory("testIn(Vin, Label, Vout) :- in(Vin, Label, Vout), 'father' = Label, !, fail."
        ...
        pipeline = graph.traversal()
                .E()
                .filter(new Predicate<Traverser<Edge>>() {
                    @Override
        ...
        pt = new PixyTheory("testEquals(V1, V2) :- V1 = V2, !, fail." + "testEquals(V1, V2)."
        ...
        for (Integer numInt : intNumbers) {
            ...
            assertTrue(new BigDecimal(-exp)
                            .subtract((BigDecimal) pipeline.next())
                            .abs()
                            .doubleValue()
                    < 0.0000001);
            assertTrue(new BigDecimal(-exp)
        ...
        pt = pt.extend("person(V, Sex, Born, Died, Nickname) :- " + "    Sex2 = Sex, property(V, 'sex', Sex2),"
        ...
        pt = pt.remove("person/5")
                .extend("person(V, Sex, Born, Died, Nickname) :- " + "    property(V, 'sex', Sex),"
                        + "    property(V, 'born', Born),"
        ...
        pt = pt.extend("invalidPerson(Person) :- " + "    property(Father, 'sex', 'female'),"
        ...
        pt = pt.extend(
                ...
                "outInTest(Person) :- " + "    outLoop(Person, AnotherPerson, 3), "
